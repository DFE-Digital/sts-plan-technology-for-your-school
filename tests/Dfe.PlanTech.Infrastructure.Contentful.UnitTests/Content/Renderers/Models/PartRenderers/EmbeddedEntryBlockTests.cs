...
public class EmbeddedEntryBlockTests
{
    ...
    private readonly ILogger<AccordionComponent> _accordionLogger = Substitute.For<ILogger<AccordionComponent>>();
    ...
    {
        var renderer = new EmbeddedEntryBlockRenderer(_loggerFactory, _embeddedEntryBlockRendererLogger);

        var stringBuilder = new StringBuilder();

        var result = renderer.AddHtml(new RichTextContent(), new AccordionComponent(_accordionLogger), stringBuilder);
    ...
    public void ShouldReturnData_WhenAccordionSystemPropertyId()
    {
        ...
        var result = renderer.AddHtml(GetCsAccordionContent(), new AccordionComponent(_accordionLogger), new StringBuilder());
