...
Feature: Print recommendations Page
  ...
  @clear-data-school
    ...
    Scenario: Print single recommendations page has correct layout content
        Given I visit the self-assessment-testing page
        And I click the card "Category Two"
        And I click the recommendation link "Recommendation Header - C2 - S3 - Q5" on the category landing page
        And I click the print recommendations link in the related action

        Then I should see the GOV.UK footer with expected links
        And I should see the beta header
        And the header should contain all the correct content
        And I should see the page heading "Category Two"
        And I should see a recommendation with heading "Recommendation Header - C2 - S3 - Q5" and content containing "Recommendation Header - C2 - S3 - Q5" on the print recommendation page
        And I should see the print this page button
    ...
    Scenario: Print single recommendation page has correct recommendations content
        Given I visit the self-assessment-testing page
        And I click the card "Category Two"
        And I click the recommendation link "Recommendation Header - C2 - S3 - Q5" on the category landing page
        And I click the print recommendations link in the related action
        ...
        Then I should see a recommendation with heading "Recommendation Header - C2 - S3 - Q5" and content containing "Recommendation Header - C2 - S3 - Q5" on the print recommendation page
        And I should see a non govuk section heading with text "Testing - C2 - S3 - Q5 - A2"
