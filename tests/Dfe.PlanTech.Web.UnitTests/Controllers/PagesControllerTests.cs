...
namespace Dfe.PlanTech.Web.UnitTests.Controllers
{
    public class PagesControllerTests
    {
        ...
        {
            var result = await _controller.GetByRoute(INDEX_SLUG, null, _query, CancellationToken.None);
        ...
        {
            await Assert.ThrowsAnyAsync<Exception>(() => _controller.GetByRoute("NOT A VALID ROUTE", null, _query, CancellationToken.None));
        }
    }
}