...
public class GroupsViewBuilderTests
{
        ...
        ILogger<BaseViewBuilder>? logger = null)
    {
        ...
        currentUser.Organisation.Returns(new OrganisationModel { Id = establishmentId, Name = "The Group" });
    ...
    public async Task RecordGroupSelectionAsync_Forwards_All_Parameters_To_Service()
    {
        ...
        currentUser.Organisation.Returns(new OrganisationModel { Id = establishmentGuid, Name = "Group X" });
        ...
        await est.Received(1).RecordGroupSelection(
            "dsi-123",
            1000,
            Arg.Is<OrganisationModel>(m => m.Id == establishmentGuid && m.Name == "Group X"),
            "URN-007",
            "Bond Primary");
    }
