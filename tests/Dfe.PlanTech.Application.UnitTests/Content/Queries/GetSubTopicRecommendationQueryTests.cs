...
public class GetSubTopicRecommendationQueryTests
{
    ...
    public async Task GetSubTopicRecommendation_Returns_Correct_SubTopicRecommendation_From_SectionOne()
    {
        ...
        SubtopicRecommendation? subTopicRecommendation = await _query.GetSubTopicRecommendation(_subTopicOne.Sys.Id);
    ...
    public async Task GetSubTopicRecommendation_Returns_Null_When_Not_Found()
    {
        ...
        SubtopicRecommendation? subTopicRecommendation = await _query.GetSubTopicRecommendation("not a real id");
    ...
    public async Task GetSubTopicRecommendation_Returns_Correct_SubTopicRecommendation_From_SectionTwo()
    {
        ...
        SubtopicRecommendation? subTopicRecommendation = await _query.GetSubTopicRecommendation(_subTopicTwo.Sys.Id);
    ...
    public async Task GetRecommendationsViewDto_Retrieves_Correct_Information_When_Existing()
    {
        ...
        var result = await _query.GetRecommendationsViewDto(_subtopicRecommendationOne!.Subtopic.Sys.Id, maturity);
    ...
    public async Task GetRecommendationsViewDto_Returns_Null_When_No_Match()
    {
        ...
        Assert.Single(_logger.GetMatchingReceivedMessages("Could not find subtopic recommendation in Contentful for any id", LogLevel.Error));
    }
}
