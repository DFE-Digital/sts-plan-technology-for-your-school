...
public class RecommendationWorkflowTests
{
    ...
    public async Task GetLatestRecommendationStatusesAsync_WhenValidInput_ThenReturnsCorrectDictionary()
    {
        ...
        var historyEntities = new[]
        {
            ...
            {
                Id = 1, EstablishmentId = establishmentId, Recommendation = recommendations[0],
                NewStatus = "InProgress", DateCreated = DateTime.UtcNow.AddDays(-2)
            },
            new EstablishmentRecommendationHistoryEntity
            {
                Id = 2, EstablishmentId = establishmentId, RecommendationId = 1, Recommendation = recommendations[0], UserId = 1,
            ...
            new EstablishmentRecommendationHistoryEntity
            {
                Id = 3, EstablishmentId = establishmentId, RecommendationId = 2, Recommendation = recommendations[1], UserId = 1,
            ...
            new EstablishmentRecommendationHistoryEntity
            {
                Id = 4, EstablishmentId = establishmentId, RecommendationId = 3, Recommendation = recommendations[2], UserId = 1,
                NewStatus = "InProgress", DateCreated = DateTime.UtcNow.AddDays(-4)
            },
            new EstablishmentRecommendationHistoryEntity
            {
                Id = 5, EstablishmentId = establishmentId, RecommendationId = 3, Recommendation = recommendations[2], UserId = 1,
                NewStatus = "Completed", DateCreated = DateTime.UtcNow.AddDays(-2)
            },
            new EstablishmentRecommendationHistoryEntity
            {
                Id = 6, EstablishmentId = establishmentId, RecommendationId = 3, Recommendation = recommendations[2], UserId = 1,
    ...
    public async Task GetLatestRecommendationStatusesAsync_WhenSingleRecommendationMultipleHistory_ThenReturnsLatestByDateCreated()
    {
        ...
        var historyEntities = new[]
        {
            ...
            new EstablishmentRecommendationHistoryEntity
            {
                Id = 2, EstablishmentId = establishmentId, RecommendationId = 1, Recommendation = recommendation, UserId = 1,
                NewStatus = "Completed", DateCreated = DateTime.UtcNow.AddDays(-2)
            },
            new EstablishmentRecommendationHistoryEntity
            {
                Id = 3, EstablishmentId = establishmentId, RecommendationId = 1, Recommendation = recommendation, UserId = 1,
