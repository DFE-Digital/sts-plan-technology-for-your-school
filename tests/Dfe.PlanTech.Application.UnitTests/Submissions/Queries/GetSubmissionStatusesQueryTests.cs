...
namespace Dfe.PlanTech.Application.UnitTests.Submissions.Queries
{
    public class GetSubmissionStatusesQueryTests
    {
        ...
        private readonly List<SectionStatuses> SectionStatuses = new() {
            new SectionStatuses { Completed = 1, SectionId = "1", Maturity = "Low", DateCreated = DateTime.UtcNow },
            new SectionStatuses { Completed = 1, SectionId = "2", Maturity = "High", DateCreated = DateTime.UtcNow },
            new SectionStatuses { Completed = 0, SectionId = "3", DateCreated = DateTime.UtcNow },
            new SectionStatuses { Completed = 0, SectionId = "4",  DateCreated = DateTime.UtcNow },
        };
