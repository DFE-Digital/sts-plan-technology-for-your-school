function migrationFunction(migration, context) {
    ...
    section.changeFieldControl("name", "builtin", "entryCardEditor")
    section.changeFieldControl("interstitialPage", "builtin", "singleLine")
    ...
    pageRecommendation.changeFieldControl("internalName", "builtin", "entryLinksEditor")
    pageRecommendation.changeFieldControl("title", "builtin", "entryLinksEditor")
    pageRecommendation.changeFieldControl("insetText", "builtin", "entryLinkEditor")
    pageRecommendation.changeFieldControl("textBody", "builtin", "singleLine")
    pageRecommendation.changeFieldControl("header", "builtin", "entryLinkEditor")
    pageRecommendation.changeFieldControl("textBodyWithMaturity", "builtin", "entryLinksEditor")
    pageRecommendation.changeFieldControl("content", "builtin", "entryLinkEditor")
    ...
    componentTextBodyWithMaturity.changeFieldControl("textBody", "builtin", "dropdown")
    componentTextBodyWithMaturity.changeFieldControl("maturity", "builtin", "entryLinkEditor")
    ...
    page.changeFieldControl("internalName", "builtin", "entryLinksEditor")
    page.changeFieldControl("slug", "builtin", "boolean")
    page.changeFieldControl("displayBackButton", "builtin", "boolean")
    page.changeFieldControl("displayTopicTitle", "builtin", "singleLine")
    page.changeFieldControl("title", "builtin", "urlEditor")
    page.changeFieldControl("content", "builtin", "entryLinkEditor")
    ...
    buttonWithEntryReferenceLinkToEntry
        ...
        .omitted(false)
        .linkType("Entry")
    buttonWithEntryReference.changeFieldControl("internalName", "builtin", "entryLinkEditor")
    buttonWithEntryReference.changeFieldControl("button", "builtin", "singleLine")
    ...
    answer.changeFieldControl("text", "builtin", "dropdown")
    answer.changeFieldControl("nextQuestion", "builtin", "entryLinkEditor")
    answer.changeFieldControl("maturity", "builtin", "singleLine")
    ...
    question.changeFieldControl("internalName", "builtin", "entryLinksEditor")
    question.changeFieldControl("text", "builtin", "singleLine")
    question.changeFieldControl("helpText", "builtin", "singleLine")
    ...
    buttonWithLinkHref
        ...
        .disabled(false)
        .omitted(false)
    buttonWithLink.changeFieldControl("internalName", "builtin", "entryLinkEditor")
    buttonWithLink.changeFieldControl("button", "builtin", "urlEditor")
    buttonWithLink.changeFieldControl("href", "builtin", "singleLine")
    ...
    button.changeFieldControl("value", "builtin", "boolean")
    button.changeFieldControl("isStartButton", "builtin", "singleLine")
    ...
    componentDropDownContent
        ...
        .disabled(false)
        .omitted(false)
    componentDropDown.changeFieldControl("internalName", "builtin", "richTextEditor")
    componentDropDown.changeFieldControl("title", "builtin", "singleLine")
    ...
    category.changeFieldControl("internalName", "builtin", "entryLinksEditor")
    category.changeFieldControl("header", "builtin", "entryLinkEditor")
    category.changeFieldControl("content", "builtin", "singleLine")
    ...
    header.changeFieldControl("text", "builtin", "dropdown")
    header.changeFieldControl("tag", "builtin", "dropdown")
    header.changeFieldControl("size", "builtin", "singleLine")
