...
public abstract class BaseJsonToDbMapper
{
  ...
  protected BaseJsonToDbMapper(EntityRetriever entityRetriever, Type entityType, ILogger logger, JsonSerializerOptions jsonSerialiserOptions)
  {
