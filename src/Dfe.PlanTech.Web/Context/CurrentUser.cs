...
public class CurrentUser : ICurrentUser
{
    ...
    public string? GetActiveEstablishmentUkprnAsync()
    {
    ...
    public string? GetActiveEstablishmentUidAsync()
    {
        // Only fall back to Organisation if no school is selected (i.e., user is a direct establishment user)
    ...
    public Guid? GetActiveEstablishmentDsiIdAsync()
    {
        // Only fall back to Organisation if no school is selected (i.e., user is a direct establishment user)
    ...
    public string? GetActiveEstablishmentReferenceAsync()
    {
