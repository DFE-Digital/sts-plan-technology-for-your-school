...
{
    public class CurrentUser(HttpContextAccessor accessor)
    {
        private readonly HttpContextAccessor _contextAccessor = accessor ?? throw new ArgumentNullException(nameof(accessor));
