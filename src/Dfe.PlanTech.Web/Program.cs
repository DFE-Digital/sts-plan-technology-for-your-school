...
builder.Services.AddSingleton<IAuthorizationHandler, UserOrganisationAuthorisationHandler>();
builder.Services.AddSingleton<IAuthorizationMiddlewareResultHandler, UserAuthorisationMiddlewareResultHandler>();
