...
{
    public static RedirectToActionResult RedirectToCategoryLandingPage(
    ...
    public static RedirectToActionResult RedirectToCheckAnswers(
        this Controller controller,
        string categorySlug,
        string sectionSlug
    ) =>
    ...
    public static RedirectToActionResult RedirectToInterstitialPage(
        this Controller controller,
        string sectionSlug
    ) => RedirectToPage(controller, sectionSlug);

    public static RedirectToActionResult RedirectToGetQuestionBySlug(
        this Controller controller,
        string categorySlug,
        string sectionSlug,
        string nextQuestionSlug
    ) =>
        controller.RedirectToAction(
    ...
    public static RedirectToActionResult RedirectToGetNextUnansweredQuestion(
        this Controller controller,
        string categorySlug,
        string sectionSlug
    ) =>
    ...
    public static RedirectToActionResult RedirectToGetContinueSelfAssessment(
        this Controller controller,
        string categorySlug,
        string sectionSlug
    ) =>
        controller.RedirectToAction(
            nameof(QuestionsController.GetContinueSelfAssessment),
            nameof(QuestionsController).GetControllerNameSlug(),
            new { categorySlug, sectionSlug }
        );
