...
namespace Dfe.PlanTech.Web.ViewBuilders.Interfaces
{
    ...
    {
        Task<IActionResult> RouteBySlugAndQuestionAsync(Controller controller, string categorySlug, string sectionSlug, string questionSlug, string? returnTo);
        ...
        Task<IActionResult> RestartSelfAssessment(Controller controller, string categorySlug, string sectionSlug, bool isObsoleteSubmissionFlow);
