...
using Dfe.PlanTech.Infrastructure.Data.Contentful.Helpers;
...
public abstract class ContentfulContext : IContentRepository
{
    private readonly IContentfulClient _client;
    private readonly IHostEnvironment _hostEnvironment;
    private readonly AutomatedTestingOptions _automatedTestingOptions;
    private readonly ILogger<ContentfulContext> _logger;

    public ContentfulContext(
    ...
    )
    {
        ...
        _logger = loggerFactory.CreateLogger<ContentfulContext>();
    }
