module "main_hosting" {
  ...
  source = "github.com/adimicoli-airelogic/terraform-azurerm-container-apps-hosting?ref=253522-Upgrade-ModuleContainerApp"
...
# Resource Group
  existing_resource_group    = "s190d01-plantech"
  # Networking
  launch_in_vnet = false
  existing_virtual_network = "s190d01-plantechdefault"
}
