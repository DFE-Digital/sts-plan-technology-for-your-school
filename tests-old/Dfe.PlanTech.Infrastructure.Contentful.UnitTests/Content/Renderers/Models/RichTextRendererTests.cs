...
public class RichTextRendererTests
{
    ...
    {
        var content = new RichTextContent() { NodeType = "paragraph" };
    ...
    public void Should_CreateHtml_When_PassedContent()
    {
        ...
        var content = new RichTextContent()
        {
            ...
            Content = new()
            {
                new RichTextContent() { NodeType = "paragraph", Value = testHtml },
            },
        };
