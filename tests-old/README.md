...
This directory contains the original test projects from an earlier version of the application. They have been superseded by the projects in [`../tests/`](../tests/README.md) and are no longer run in CI.
