...
MIN_RECORDS: dict[str, int] = {
    ...
    "administrative_districts": 350,
    "administrative_wards": 10000,
    "admissions_policies": 3,
    "establishment_statuses": 4,
    "establishment_type_groups": 10,
    "genders": 3,
    "government_office_regions": 11,
    "group_statuses": 2,
    "group_types": 5,
    "local_authorities": 100,
    "parliamentary_constituencies": 1150,
    "phases": 6,
    "religious_characters": 45,
    "sixth_form_statuses": 3,
    "trusts": 2250,
    "trust_school_flags": 4,
    "types_of_establishment": 35,
    "urban_rural_classifications": 20,
}
...
def validate_data_quality(data: GiasData) -> None:
    ...
    sizes = {
        ...
        "administrative_districts": len(data.administrative_districts),
        "administrative_wards": len(data.administrative_wards),
        "admissions_policies": len(data.admissions_policies),
        "establishment_statuses": len(data.establishment_statuses),
        "establishment_type_groups": len(data.establishment_type_groups),
        "genders": len(data.genders),
        "government_office_regions": len(data.government_office_regions),
        "group_statuses": len(data.group_statuses),
        "group_types": len(data.group_types),
        "local_authorities": len(data.local_authorities),
        "parliamentary_constituencies": len(data.parliamentary_constituencies),
        "phases": len(data.phases),
        "religious_characters": len(data.religious_characters),
        "sixth_form_statuses": len(data.sixth_form_statuses),
        "trusts": len(data.trusts),
        "trust_school_flags": len(data.trust_school_flags),
        "types_of_establishment": len(data.types_of_establishment),
        "urban_rural_classifications": len(data.urban_rural_classifications),
    }
