...
export default class DataMapper {
    ...
    *sectionsToClasses(sections) {
        ...
        const subtopicRecommendations = Array.from(
            this.contents.get("subtopicRecommendation") ?? []
        );
    ...
    convertToMinimalSectionInfo(section, writeAllPossiblePaths = false) {
        return {
            ...
            minimumQuestionPaths:
                section.pathInfo.minimumPathsToNavigateQuestions,
        ...
        Object.entries(entry.fields).forEach(([key, value]) => {
            ...
            if (Array.isArray(value)) {
                entry.fields[key] = value
                    .map((item) => {
                        const matching = this.getMatchingContentForReference(
