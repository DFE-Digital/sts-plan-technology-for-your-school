...
const getClientMock = jest.fn().mockImplementation(() => Promise.resolve(getAndValidateClientMock));
...
describe('deleteEntry', () => {
  ...
  it('should handle errors during unpublishing', async () => {
    ...
    await expect(deleteEntry(publishedEntry)).rejects.toThrow('Unpublish failed');
