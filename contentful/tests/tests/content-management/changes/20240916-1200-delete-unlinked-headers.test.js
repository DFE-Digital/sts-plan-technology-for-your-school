...
jest.unstable_mockModule(
    "../../../../content-management/helpers/delete-entry.js",
    () => ({
...
const getAndValidateClientMock = jest
    .fn()
    .mockImplementation(() => Promise.resolve(clientMock));
...
const deleteUnlinkedHeaders = (
    await import(
        "../../../../content-management/changes/20240916-1200-delete-unlinked-headers.js"
    )
).default;
