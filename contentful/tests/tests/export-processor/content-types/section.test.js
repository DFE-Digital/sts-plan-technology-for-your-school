...
jest.unstable_mockModule(
    "../../../../export-processor/user-journey/path-calculator",
    () => ({
...
jest.unstable_mockModule(
    "../../../../export-processor/user-journey/section-stats",
    () => ({
...
jest.unstable_mockModule(
    "../../../../export-processor/content-types/question",
    () => ({
...
const { Section } = await import(
    "../../../../export-processor/content-types/section"
);
const { PathCalculator } = await import(
    "../../../../export-processor/user-journey/path-calculator"
);
const { SectionStats } = await import(
    "../../../../export-processor/user-journey/section-stats"
);
