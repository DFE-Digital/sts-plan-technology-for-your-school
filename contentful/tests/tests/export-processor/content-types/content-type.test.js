...
describe("ContentType", () => {
    ...
    test("should throw error if field does not exist", () => {
        expect(() =>
            contentType.getReferencedTypesForField("nonExistentField")
        ).toThrow();
    });

    test("should return false for non-referenced Array field with no validations", () => {
        const mockFieldsWithoutValidation = [
            { id: "field1", type: "Array", items: {} },
        ];
        ...
        const linkedTypes =
            contentTypeWithoutValidation.getReferencedTypesForField("field1");
