...
describe('SubtopicRecommendation', () => {
  ...
  describe('Constructor', () => {
    test('should create a SubtopicRecommendation with valid data', () => {
      ...
      expect(subtopicRecommendation.intros.length).toEqual(fields.intros.length);
      expect(subtopicRecommendation.section.id).toEqual(fields.section.sys.id);
      expect(subtopicRecommendation.subtopic.id).toEqual(fields.subtopic.sys.id);
    });
    ...
    describe('should handle missing subtopic gracefully', () => {
      ...
      test('Undefined', () => {
        ...
        expect(ErrorLogger.addError).toHaveBeenCalledWith(expectedErrorArgs);
      });
    ...
    test('getContentForMaturityAndPath', () => {
      jest
        .spyOn(RecommendationSection.prototype, 'getChunksForPath')
